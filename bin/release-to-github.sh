...
echo " • Make sure you have updated the plugin version in wp-openapi.phpV"
...
hub release create -m $VERSION -m "Release of version $VERSION." -t $BRANCH "v${VERSION}" --attach "./hooks-reference.zip"
